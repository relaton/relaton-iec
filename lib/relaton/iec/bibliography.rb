    ...
    class Bibliography
      ...
      class << self
        ...
        def search(ref, year = nil)
          ...
          HitCollection.new(ref, year&.strip).search
        ...
        def fetch_ref_err(code, year, missed_years) # rubocop:disable Metrics/MethodLength
          ...
          unless DOCTYPES.any? { |t| code.include?("#{t} ") }
        ...
        def iev(code = "IEC 60050")
          ...
          # Relaton::IsoBib::XMLParser.from_xml(<<~"XML")
          #   <bibitem>
        ...
        #
        # @param [Relaton::Iec::HitCollection] result search results
        ...
        #
        # @return [Array<Relaton::Iec::ItemData, Array, nil>] result, missed parts
        #
        ...
        def iecbib_get(code, year, opts) # rubocop:disable Metrics/AbcSize,Metrics/MethodLength
          ...
          id = ref_with_year(code, year)
          docid = ret[:ret].docidentifier.first.content
